 ...
 */
function clickpublish_attendees_block_init() {
	...
	$index_js = 'clickpublish-attendees/index.js';
	wp_register_script(
		'clickpublish-attendees-block-editor',
	...
	$editor_css = 'clickpublish-attendees/editor.css';
	wp_register_style(
		'clickpublish-attendees-block-editor',
	...
	$style_css = 'clickpublish-attendees/style.css';
	wp_register_style(
		'clickpublish-attendees-block',
		plugins_url( $style_css, __FILE__ ),
		[],
		filemtime( "{$dir}/{$style_css}" )
	);

	register_block_type( 'clickpublish-blocks/clickpublish-attendees', [
		'editor_script'   => 'clickpublish-attendees-block-editor',
		'editor_style'    => 'clickpublish-attendees-block-editor',
		'style'           => 'clickpublish-attendees-block',
    'render_callback' => 'clickpublish_attendees_block_render',
	] );
} // end clickpublish_attendees_block_init

add_action( 'init', 'clickpublish_attendees_block_init' );

function clickpublish_attendees_block_render( $block_attributes, $content ) {
  ...
  return ob_get_clean();
} // end clickpublish_attendees_block_render
